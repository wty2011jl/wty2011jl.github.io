...
- [COMST] **Wanting Yang** et al., "Semantic Communications for Future Internet: Fundamentals, Applications, and Challenges," in IEEE Communications Surveys & Tutorials, vol. 25, no. 1, pp. 213-250, Firstquarter 2023. [PDF](/files/COMST_Semantic_Communications_for_Future_Internet_Fundamentals_Applications_and_Challenges.pdf)   
...
- [TWC] **Wanting Yang**, Z. Xiong, Y. Yuan, W. Jiang, T. Q. S. Quek and M. Debbah, "Agent-Driven Generative Semantic Communication With Cross-Modality and Prediction," in IEEE Transactions on Wireless Communications, vol. 24, no. 3, pp. 2233-2248, March 2025. [PDF](/files/TWC_Agent-Driven_Generative_Semantic_Communication_With_Cross-Modality_and_Prediction.pdf)  
- [TCOM] **Wanting Yang**, X. Chi, L. Zhao, Z. Xiong and W. Jiang, "Task-Driven Semantic-Aware Green Cooperative Transmission Strategy for Vehicular Networks," in IEEE Transactions on Communications, vol. 71, no. 10, pp. 5783-5798, Oct. 2023. [PDF](/files/TCOM_Task-Driven_Semantic-Aware_Green_Cooperative_Transmission_Strategy_for_Vehicular_Networks.pdf)  
...
- [AAAI-W-ML4Wireless] N. Li, **Wanting Yang**, et al. "Hierarchical Collaborative Fine-Tuning for Personalized Edge-End Hybrid Inference of Stable Diffusion Models", in AAAI 2026 Workshop on ML4Wireless. [PDF](/files/17_Hierarchical_Collaborative_.pdf)
...
- [WCM] B. Guo, **Wanting Yang** et al., "Enhancing Mega-Satellite Networks With Generative Semantic Communication: A Networking Perspective," in IEEE Wireless Communications, doi: 10.1109/MWC.2025.3596938. [PDF](/files/Enhancing_Mega-Satellite_Networks_With_Generative_Semantic_Communication_A_Networking_Perspective.pdf)
- [TVT] H. Yan, X. Chi, **Wanting Yang**, Z. Xiong and Z. Han, "Peak Age of Information Analysis for Real-Time Status Update Systems Based on Martingale Theory," in IEEE Transactions on Vehicular Technology. [PDF](/files/Peak_Age_of_Information_Analysis_for_Real-Time_Status_Update_Systems_Based_on_Martingale_Theory.pdf)
